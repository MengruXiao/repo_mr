'''
get_glue_args
# https://stackoverflow.com/questions/52161964/optional-job-parameter-in-aws-glue
'''

'''

get_glue_args是一个udf
用于取出glue的job_details下参数的值，那些参数的可能是自己手工配置的，也可能是step_function或者lambda传入的

get_glue_args详细代码：

# 注意是放在glue里用的，不是在本地运行
